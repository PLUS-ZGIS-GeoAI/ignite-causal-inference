...
def temporal_train_test_split(
    train_data: pd.DataFrame, date_col: str, train_size: float
) -> tuple:
...
def preprocess_data(data: pd.DataFrame) -> pd.DataFrame:
    ...
    processed_data_dict = {
        ...
        "forest_type": data["forest_type"].apply(
            lambda x: apply_encoding(int(x), forest_type_mapping)
        ),
